...
def device_jit(fn: Fn, **kwargs: Any) -> Fn:
    """Compiles a function for execution on a GPU (device) using Numba's JIT compiler.
...
def jit(fn: Fn, **kwargs: Any) -> FakeCUDAKernel:
    """Compiles a function using Numba's JIT compiler for general use (not necessarily on a GPU).
...
def _tensor_matrix_multiply(
    ...
    ----
        ...
        out_strides: The strides (step sizes) to access elements in the output tensor.
        out_size: The total number of elements in the output tensor.
        a_storage: The storage (data) of the first input tensor.
        a_shape: The shape (dimensions) of the first input tensor.
        a_strides: The strides (step sizes) to access elements in the first input tensor.
        b_storage: The storage (data) of the second input tensor.
        b_shape: The shape (dimensions) of the second input tensor.
        b_strides: The strides (step sizes) to access elements in the second input tensor.
